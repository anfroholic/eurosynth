...
//
//   Memory image (neural_weights.hex, $readmemh at elaboration):
...
module neural_osc #(
    ...
    parameter WFILE      = "models/neural_weights.hex"
)(
    input  wire clk,
    ...
    // ---------------------------------------------------------------------
    // Combined memory: sine LUT then MLP weights. Loaded at elaboration; the
    // w_we port can overwrite weight words at runtime (SPI).
    // ---------------------------------------------------------------------
